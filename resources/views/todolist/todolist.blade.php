...
<body>
    <div class="container col-xl-10 col-xxl-8 px-4 py-5">
        ...
        @php
            $confirm = "Want to Logout " . session()->get('user');
        @endphp
        <div class="row">
            <form method="post" action="/logout" onclick="return confirm(`Want to Logout {{ session()->get('user') }} ?`)">
                @csrf
        ...
        <div class="row align-items-center g-lg-5 py-5">
            <div class="col-lg-7 text-center text-lg-start">
                ...
                <p class="col-lg-10 fs-4">by <a target="_blank" href="https://pangestu-k.github.io/">Pangestuk</a></p>
            </div>
